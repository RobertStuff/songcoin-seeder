...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Songcoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.songcoin.com", "seed.songcoin.org", "explorer.songcoin.org", ""};
static const string testnet_seeds[] = {""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 8335), true);
  }
  do {
